...
Hey, here we gonna show, how to build one simple Widget in Stateful, and one Stateless.
To explain the main difference between their, state is information that can be read
